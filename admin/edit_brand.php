<?php
	...
	if(isset($_POST['btnedtbrnd']) && ($_POST['btnedtbrnd'] != "") && 	
	   ...
	   isset($_POST['txtprior']) && ($_POST['txtprior'] != "")){
		   ...
		   include_once "../database/uqry_brnd_mst.php";
	   }
		  ...
		  <table width="95%"  border="0" cellspacing="1" cellpadding="3">
            <form name="frmedtbrnd" id="frmedtbrnd" method="post" action="<?php $_SERVER['SCRIPT_FILENAME'];?>" onSubmit="return performCheck('frmedtbrnd', rules, 'inline');" enctype="multipart/form-data">
             ...
             <tr align="left" bgcolor="#333333">
				 ...
				 <span class="heading"><strong>Edit Brands </strong></span>&nbsp;&nbsp;&nbsp;</td>
                </tr>	
			  <tr>
			  <tr bgcolor="#f9f8f8">
                ...
                <td width="40%" align="left" valign="middle" >
                  <input name="txtname" type="text" class="select" id="txtname" size="45" maxlength="40" value="<?php echo $rowsbrnd_mst['brndm_name'];?>" onBlur="funcChkDupName()"></td>
			  ...
			  <tr bgcolor="#f9f8f8">
                <td align="left" valign="top"  colspan="4">
                  <textarea name="txtdesc" cols="60" rows="15" id="txtdesc"><?php echo $rowsbrnd_mst['brndm_desc'];?></textarea>
                  </td>
                </tr>
              <tr bgcolor="#F2F1F1">
             ...
             <tr bgcolor="#F2F1F1">
				   <td width="18%"  align="left" valign="top" ><strong>SEO Title</strong></td>
					...
					<td width="80%"  colspan="2">
					 <input name="txtseotitle" type="text" class="select" id="txtseotitle" size="30" maxlength="50" value="<?php echo  $rowsbrnd_mst['brndm_seotitle'];?>">
					</td>														
				 </tr>
				  <tr bgcolor="#f9f8f8">
					...
					<td width="2%"  align="left" valign="top">:</td>
					<td width="80%"  colspan="2">
					<textarea name="txtseodesc" cols="33" rows="4" id="txtseodesc"><?php echo $rowsbrnd_mst['brndm_seodesc'];?></textarea></td>														
				 </tr>
				  <tr bgcolor="#F2F1F1">
					<td width="18%"  align="left" valign="top"><strong>SEO Keyword</strong></td>
					<td width="2%"  align="left" valign="top">:</td>
					<td width="80%"  colspan="2">
					<textarea name="txtseokywrd" type="text" id="txtseokywrd" cols="33" rows="4"><?php echo $rowsbrnd_mst['brndm_seokywrd'];?></textarea>
					</td>														
				 </tr>
				 <tr bgcolor="#f9f8f8"> 
					...
					<input name="txtseoh1ttl" type="text" class="select" id="txtseoh1ttl" size="30" maxlength="50" value="<?php echo $rowsbrnd_mst['brndm_seohonetitle'];?>"></td>
				</tr>
				 <tr bgcolor="#F2F1F1"> 
					<td width="16%" align="left" valign="top" ><strong>SEO H1-Description</strong></td>
					<td width="2%" align="center" valign="top" >:</td>
					<td colspan="2" align="left" valign="middle" >
					<textarea name="txtseoh1desc" id="txtseoh1desc" cols="33" rows="4" class="select"><?php echo $rowsbrnd_mst['brndm_seohonedesc'];?></textarea>			
					</td>
				  </tr>
				  <tr bgcolor="#f9f8f8"> 
					...
					<td width="2%" align="center" valign="top" >:</td>
					<td colspan="2" align="left" valign="middle" >
					<input name="txtseoh2ttl" type="text" class="select" id="txtseoh2ttl" size="30" maxlength="50" value="<?php echo $rowsbrnd_mst['brndm_seohtwotitle'];?>"></td>
				</tr>
				  <tr bgcolor="#F2F1F1"> 
					<td width="16%" align="left" valign="top" ><strong>SEO H2-Description</strong></td>
					<td width="2%" align="center" valign="top" >:</td>
					<td colspan="2" align="left" valign="middle" >
					<textarea name="txtseoh2desc" id="txtseoh2desc" cols="33" rows="4" class="select"><?php echo $rowsbrnd_mst['brndm_seohtwodesc'];?></textarea>			
					</td>
			  </tr>
			  <tr bgcolor="#f9f8f8">
                <td > <strong>Rank</strong> * </td>
                <td ><strong>:</strong></td>
                <td ><input type="text" name="txtprior" id="txtprior" class="select" size="4" maxlength="3" value="<?php echo $rowsbrnd_mst['brndm_prty'];?>"></td>
              ...
              <tr valign="middle" bgcolor="#f9f8f8">
                <td colspan="4" align="center" >
                  <input type="Submit" class="textfeild"  name="btnedtbrnd" id="btnedtbrnd" value="Submit">
                  &nbsp;&nbsp;&nbsp;
