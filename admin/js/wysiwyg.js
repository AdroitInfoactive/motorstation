...
var buttonName2 = new Array();
	...
	buttonName2[5]  = "redo";
 	buttonName2[6]  = "seperator";
  	buttonName2[7]  = "insertimage";
  	buttonName2[8]  = "createlink";
	buttonName2[9]  = "seperator";
	buttonName2[10]  = "viewSource";
...
function formatText(id, n, selected) {
  ...
  document.getElementById("wysiwyg" + n).contentWindow.focus();
	...
	var formatIDs = new Array("FontSize","FontName","Bold","Italic","Underline","Subscript","Superscript","Strikethrough","Justifyleft","Justifyright","Justifycenter","InsertUnorderedList","InsertOrderedList","Indent","Outdent","InsertImage","InsertTable","CreateLink");
