...
?>
   <script language="javascript" type="text/javascript">
	function funcChkDupName()
	{
		...
		if(name!="")
		{
			var url = "chkvalidname.php?vehtypname="+name;
      ...
      <tr>
        ...
        <td width="700" height="325" rowspan="2" valign="top"  bgcolor="#FFFFFF" class="contentpadding" style="background-position:top; background-repeat:repeat-x; ">
          ...
          <table width="95%"  border="0" cellspacing="1" cellpadding="3">
            <form name="frmavehtypcat" id="frmavehtypcat" method="post" action="<?php $_SERVER['SCRIPT_FILENAME'];?>" 
		  		onSubmit="return performCheck('frmavehtypcat', rules, 'inline');" enctype="multipart/form-data">
             <tr class='white'>
			...
			<textarea name="txtseoh2desc" id="txtseoh2desc" cols="33" rows="4" class="select"></textarea>			
              ...
              <tr valign="middle" bgcolor="#F2F1F1">
                <td colspan="4" align="center" >
                  <input type="Submit" class="textfeild"  name="btnaddvehtyp" id="btnaddvehtyp" value="Submit">
                  &nbsp;&nbsp;&nbsp;
                  <input type="reset" class="textfeild"  name="btnprdctcatreset" value="Reset" id="btnprdctcatreset">
                  &nbsp;&nbsp;&nbsp;
                  <input type="button"  name="btnBack" value="Back" class="textfeild" onClick="location.href='view_all_vehicle_type.php'">				                </td>
                </tr>
              </form>
            </table>
          </td>
