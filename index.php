    ...
    <div class="container">
        ...
        <div class="row mt-25 justify-content-center">
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-6">
                <div class="blog__item-2 blog__item-2-df mb-3">
                    <div class="blog__item-2-image">
                        <div class="blog__item-2-image-inner w-img">
                            <a href="<?php echo $rtpth; ?>services"><img
                                    src="assets/img/services/multi-brand-tyre-tubes-sales.jpg" alt=""></a>
                        </div>
                    </div>
                    <div class="blog__item-2-content home-prdt-content">
                        <h5 class="blog__sm-title m-0"><a href="<?php echo $rtpth; ?>services">Multi Brand Tyre & Tubes
                                Sales</a></h5>
                    </div>
                    <div class="blog__btn-2">
                        <a href="<?php echo $rtpth; ?>services" class="link-btn"> Read more <i
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-6">
                <div class="blog__item-2 blog__item-2-df mb-3">
                    <div class="blog__item-2-image">
                        <div class="blog__item-2-image-inner w-img">
                            <a href="<?php echo $rtpth; ?>services"><img
                                    src="assets/img/services/3D-alignment-checking.jpg" alt=""></a>
                        </div>
                    </div>
                    <div class="blog__item-2-content home-prdt-content">
                        <h5 class="blog__sm-title m-0"><a href="<?php echo $rtpth; ?>services">3D Alignment &
                                Checking</a></h5>
                    </div>
                    <div class="blog__btn-2">
                        <a href="<?php echo $rtpth; ?>services" class="link-btn"> Read more <i
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-6">
                <div class="blog__item-2 blog__item-2-df mb-3">
                    <div class="blog__item-2-image">
                        <div class="blog__item-2-image-inner w-img">
                            <a href="<?php echo $rtpth; ?>services"><img src="assets/img/services/wheel-balancing.jpg"
                                    alt=""></a>
                        </div>
                    </div>
                    <div class="blog__item-2-content home-prdt-content">
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-6">
                <div class="blog__item-2 blog__item-2-df mb-3">
                    <div class="blog__item-2-image">
                        <div class="blog__item-2-image-inner w-img">
                            <a href="<?php echo $rtpth; ?>services"><img src="assets/img/services/nitrogen-air.jpg"
                                    alt=""></a>
                        </div>
                    </div>
                    <div class="blog__item-2-content home-prdt-content">
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-6">
                <div class="blog__item-2 blog__item-2-df mb-3">
                    <div class="blog__item-2-image">
                        <div class="blog__item-2-image-inner w-img">
                            <a href="<?php echo $rtpth; ?>services"><img src="assets/img/services/general-service.jpg"
                                    alt=""></a>
                        </div>
                    </div>
                    <div class="blog__item-2-content home-prdt-content">
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-6">
                <div class="blog__item-2 blog__item-2-df mb-3">
                    <div class="blog__item-2-image">
                        <div class="blog__item-2-image-inner w-img">
                            <a href="<?php echo $rtpth; ?>services"><img
                                    src="assets/img/services/personalised-services.jpg" alt=""></a>
                        </div>
                    </div>
                    <div class="blog__item-2-content home-prdt-content">
                        <h5 class="blog__sm-title m-0"><a href="<?php echo $rtpth; ?>services">Personalised Services</a>
                        </h5>
                    </div>
                    <div class="blog__btn-2">
                        <a href="<?php echo $rtpth; ?>services" class="link-btn"> Read more <i
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-6">
                <div class="blog__item-2 blog__item-2-df mb-3">
                    <div class="blog__item-2-image">
                        <div class="blog__item-2-image-inner w-img">
                            <a href="<?php echo $rtpth; ?>services"><img src="assets/img/services/general-checup.jpg"
                                    alt=""></a>
                        </div>
                    </div>
                    <div class="blog__item-2-content home-prdt-content">
                        <h5 class="blog__sm-title m-0"><a href="<?php echo $rtpth; ?>services">General Check-Up </a>
                        </h5>
                    </div>
                    <div class="blog__btn-2">
                        <a href="<?php echo $rtpth; ?>services" class="link-btn"> Read more <i
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-6">
                <div class="blog__item-2 blog__item-2-df mb-3">
                    <div class="blog__item-2-image">
                        <div class="blog__item-2-image-inner w-img">
                            <a href="<?php echo $rtpth; ?>services"><img src="assets/img/services/car-wash.jpg"
                                    alt=""></a>
                        </div>
                    </div>
                    <div class="blog__item-2-content home-prdt-content">
                        <h5 class="blog__sm-title m-0"><a href="<?php echo $rtpth; ?>services">Car Wash </a></h5>
                    </div>
                    <div class="blog__btn-2">
                        <a href="<?php echo $rtpth; ?>services" class="link-btn"> Read more <i
                                class="fal fa-long-arrow-right"></i></a>
                    ...
                    <div class="testimonial__slider-2 swiper-container">
                        <div class="testimonial__slider-2-wrapper swiper-wrapper">
                            ...
                            <div class="testimonial__item testimonial__item-3 swiper-slide">
                                <p class="review__text">“ I recently had my car serviced at Motor Station and I was
                            ...
                            <div class="testimonial__item testimonial__item-3 swiper-slide">
                                <p class="review__text">“ The service was excellent and the staff were friendly and
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-8 banner-slide-height">
                            ...
                            <div class="sd-content">
                                <form name="frmenqtyre" id="frmenqtyre" method="post" action=""
                                    onSubmit="return performCheck('frmenqtyre', rules_1, 'inline');">
                                        ...
                                        <div class="container">
                                            <div class="row">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="contact-filed contact-icon-mail mb-20">
                                                                <input email="text" name="txtemailid" id="txtemailid"
                                                                    placeholder="Email Id">
                                                                <span id="errorsDiv_txtemailid"
                                                        ...
                                                        <div class="col-12">
                                                            <div class="contact-filed car-icon mb-20">
                                                                <input type="text" name="txtvehicle" id="txtvehicle"
                                                                    placeholder="Vehicle Name">
                                                                <span id="errorsDiv_txtvehicle"
                                                                    style="color:red"></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-lg-6 col-md-6 frm-22-hm">
                                                    <p class="text-uppercase mb-0 text-white"><strong>Tyre
                                                    ...
                                                    <div class="d-flex">
                                                        <div class="form-check mb-0 d-flex">
                                                            <input class="form-check-input" type="radio"
                                                                name="lstvchltyp" id="lstvchltyp" value="y" checked>
                                                        ...
                                                        <div class="form-check mb-0 d-flex ms-3">
                                                            <input class="form-check-input" type="radio"
                                                                name="lstvchltyp" id="lstvchltyp" value="n">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12 mb-0">
                                                            <p class="text-uppercase mb-0 mt-2 text-white">
                                                                ...
                                                                <div class="col-xxl-12 col-lg-12 mb-0">
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="checkbox"
                                                                            value="0" id="0" name="srvctyp[]" checked>
                                                ...
                                                <div class="ab-button col-12">
                                                    ...
                                                    <input type="submit" class="tp-btn-3 w-100 text-center"
                                                        name="btnsertyre" id="btnsertyre" value="Submit">
                                                </div>
...
left join prod_mst on prodm_brndm_id = brndm_id 
 where brndm_sts='a'  and prodm_sts='a' and prodm_id!='' group by prodm_brndm_id  order by brndm_name asc";
