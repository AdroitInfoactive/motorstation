            ...
            <div class="col-xl-6 col-lg-6 col-md-6 col-11">
                <div class="text-center py-4 px-2" style="background-color: rgba(62, 182, 85, 0.18);">
                    ...
                    <div class="section__wrapper mb-2">
                        <h4 class="section__title ms-0">Thankyou for Products enquiry</h4>
                    </div>
                    <p>We really appreciate your enquiry about our products. Details enquiry has been sent successfully. We will get back to you soon.</p>
