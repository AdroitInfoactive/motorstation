                ...
                <div class="blog__item-2 blog__item-2-df mb-lg-0 mb-md-0 mb-3">
                    <div class="blog__item-2-image">
                        <div class="blog__item-2-image-inner w-img pt-2">
                            <a href="product-display.php"><img src="<?php echo 	$vehprodimgpth;?>" alt=""></a>
                        </div>
                    </div>
                    <div class="blog__item-2-content">
                        <h5 class="blog__sm-title text-center"><a href="product-display.php"><?php echo $prod_nm;?></a></h5>
                    ...
                    <div class="blog__btn-2">
										<a href="<?php echo $rtpth;?>product-display.php?type=<?php echo $veh_typ; ?>&vehbrnd=<?php echo $brand; ?>&prd_code=<?php echo $prod_code; ?>&prd_name=<?php echo $prod_nm;?>" class="link-btn"> Details <i class="fal fa-long-arrow-right"></i></a>
