...
<head>
  ...
  <!-- CSS here -->
  <link rel="stylesheet" href="<?php echo $rtpth; ?>assets/css/bootstrap.css">
  <link rel="stylesheet" href="<?php echo $rtpth; ?>assets/css/meanmenu.css">
  <link rel="stylesheet" href="<?php echo $rtpth; ?>assets/css/animate.css">
  <link rel="stylesheet" href="<?php echo $rtpth; ?>assets/css/owl-carousel.css">
  <link rel="stylesheet" href="<?php echo $rtpth; ?>assets/css/swiper-bundle.css">
  <link rel="stylesheet" href="<?php echo $rtpth; ?>assets/css/backtotop.css">
  ...
  <link rel="stylesheet" href="<?php echo $rtpth; ?>assets/css/flaticon.css">
  <link rel="stylesheet" href="<?php echo $rtpth; ?>assets/css/font-awesome-pro.css">
  <link rel="stylesheet" href="<?php echo $rtpth; ?>assets/css/spacing.css">
                  ...
                  <li class="has-dropdown"><a href="#">Tyres</a>
                    <ul class="sub-menu">
                      ...
                      ?>
                        ...
                        <li><a href="<?php echo $rtpth.$veh_name; ?>"><?php echo $veh_name; ?></a></li>
                      <?php } ?>
                    </ul>
                  </li>
    ...
    <div class="sidebar__wrapper">
      ...
      <div class="sidebar__content">
        <div class="sidebar__logo mb-40">
          <a href="index.html">
            <img src="<?php echo $rtpth; ?>assets/img/logo/motor-station-logo-1.png" alt="logo">
          </a>
        </div>
