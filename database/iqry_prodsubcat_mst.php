		...
		if($rows < 1){
			...
			$iqryprodsubcat_mst="insert into prodscat_mst(
								  prodscatm_name,prodscatm_desc,prodscatm_prodcatm_id,prodscatm_seotitle,
							 	  prodscatm_seodesc,prodscatm_seokywrd,prodscatm_seohonettl,prodscatm_seohtwottl,
								  prodscatm_seohonedesc,prodscatm_seohtwodesc,prodscatm_prty,prodscatm_sts,
								  prodscatm_crtdon,prodscatm_crtdby)values(
