...
include('header.php');
if (
  isset($_POST['btnfedenq']) && ($_POST['btnfedenq'] != "") && isset($_POST['txtname']) && ($_POST['txtname'] != "") &&
                  ...
                  <table border='0' cellpadding='0' cellspacing='0' class='table table table-condensed table-bordered'>
                    ...
                    ?>
                      <tr>
                        ...
                        <td width='10%'><a href='' onclick="del_crt_prdt(<?php echo $i; ?>)"><i class="fa fa-remove"></i></a></td>
                      </tr>
                    <?php
                      $i++;
                    }
...
<script type="text/javascript">
  function del_crt_prdt(prodid) {
    ...
    if (delsts == true) {
      var url = "<?php echo $rtpth; ?>add_crt.php?prodid=" + prodid + "&typ=d";
    ...
    if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete") {
      ...
      if (temp != "") {
       ...
       // alert(temp);
        if (temp == 'y') {
          //location.reload();
          window.location = "<?php echo $rtpth; ?>view_cart.php";
        } else {
